...
var table = ee.FeatureCollection("users/wufvckshuo/QingJiang");
...
var lulc = ee.Image(esri_lulc2020.first()).select("b1").clip(geometry);

var training = landsatComposite.addBands(lulc).sample({
    numPixels: 5000,
    scale: 30,
    region: geometry,
    seed: 0
